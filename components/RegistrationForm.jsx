    ...
    return (
        <div className={styles.formSection}>
            ...
            <div className={styles.formGrid}>
                ...
                {requireConsent && (
                    <div className={styles.inputGroup}>
                        <label htmlFor="reg-consent">NSA Consent Form * (PDF, max 5MB)</label>
                        <input
                            id="reg-consent"
                            type="file"
                            ...
                            onChange={(e) => {
                                ...
                                if (file && file.type !== 'application/pdf') {
                                    setFileError('Please select a valid PDF file for the NSA Consent Form.');
                    ...
                    <div style={{
                        ...
                        <div style={{ fontSize: '0.95rem', color: '#475569', lineHeight: '1.6', marginBottom: '24px', overflowY: 'auto', paddingRight: '10px', flex: 1 }}>
                            <ul style={{ paddingLeft: '20px', margin: '0', display: 'flex', flexDirection: 'column', gap: '14px' }}>
                                <li>I hereby confirm my participation in the National Sports Academy events.</li>
                                <li>I hereby authorize the staff of National Sports Academy to act for me according to their best judgment in any emergency requiring medical attention.</li>
                                <li>I hereby waive and release National Sports Academy and its staff from any and all liabilities for any accident or injuries incurred while the tournament, travelling or sightseeing from the venue.</li>
                                <li>All medical expenses incurred will be the responsibility of the participant or the participant's family/guardian.</li>
                                <li>National Sports Academy is not responsible for the lost, stolen or damage of any personal belonging of participants.</li>
                                ...
                                <li>The NSA Team has a Zero-Tolerance Policy towards alcohol, tobacco, and any other harmful substances. If any such substances are used or found in the possession of any athlete, the athlete will be Banned & will not be allowed to participate in any competitions.</li>
                                <li>I understand National Sports Academy retains the rights to use any photographs, videotapes, motion picture recording or any other record of the event for publicity, advertising or any legitimate purpose.</li>
                            </ul>
                        </div>
